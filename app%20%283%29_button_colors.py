...
def get_main_keyboard(user_id):
    keyboard = [
        [KeyboardButton("💳 Account Balance", style="primary"), KeyboardButton("🛒 Buy Number", style="success")],
        [KeyboardButton("🌐 Set Country", style="primary"), KeyboardButton("📱 Set Service", style="primary")],
        [KeyboardButton("👤 Profile", style="primary"), KeyboardButton("💵 Deposit", style="success")]
    ]
    if user_id == ADMIN_ID:
...
async def handle_messages(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "🌐 Set Country":
        country_kb = [
            [KeyboardButton("Country: HK (Hong Kong)", style="primary"), KeyboardButton("Country: US (USA)", style="primary")],
            [KeyboardButton("Country: RU (Russia)", style="primary"), KeyboardButton("Country: IN (India)", style="primary")],
            [KeyboardButton("🔙 Main Menu", style="danger")]
        ]
    ...
    if text == "📱 Set Service":
        service_kb = [
            [KeyboardButton("Service: WA (WhatsApp)", style="primary"), KeyboardButton("Service: TG (Telegram)", style="primary")],
            [KeyboardButton("Service: GO (Google/Gmail)", style="primary"), KeyboardButton("Service: IM (Imo)", style="primary")],
            [KeyboardButton("🔙 Main Menu", style="danger")]
        ]
    ...
    if text == "🛒 Buy Number":
        ...
        if isinstance(res, dict) and "tel" in res and "idNum" in res:
            ...
            inline_kb = InlineKeyboardMarkup([
                [InlineKeyboardButton("📩 Check Active OTP", callback_data=f"check_otp_{id_num}", style="success")],
